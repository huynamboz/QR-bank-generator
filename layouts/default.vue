<template>
	<div>
		<div class="w-[100vw] h-[56px] border-b-[1px] flex justify-center">
			<div class="w-full max-w-[1440px] h-full flex items-center px-5 justify-between">
				<p class="text-xl font-medium">Tạo QR chuyển tiền 🪄</p>
				<div>
					<a href="https://github.com/huynamboz">
